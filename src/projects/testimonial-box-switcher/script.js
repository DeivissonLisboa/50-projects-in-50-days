...
const TESTIMONIAL_TEXT = TESTIMONIAL_CONTAINER.querySelector(".testimonial")
const USER_IMAGE = TESTIMONIAL_CONTAINER.querySelector(".user-image")
const USER_NAME = TESTIMONIAL_CONTAINER.querySelector(".username")
const USER_ROLE = TESTIMONIAL_CONTAINER.querySelector(".role")
